...
export class Verification extends Component {
    ...
    handleConfirmationSubmit = async event => {
        ...
        try {
            ...
            this.props.history.push(`/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/`);
        } catch (e) {
            alert(e.message);
                    ...
                    <CardContent className={'card-inside'}>
                        ...
                        <form>
                            ...
                            <div className={'action-row'}>
                                ...
                                <div>
                                    <Link to={`/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/signup`} style={{textDecoration: 'none'}}>
