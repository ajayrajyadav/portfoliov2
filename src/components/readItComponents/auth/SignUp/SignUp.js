...
class SignUp extends Component {
    ...
    handleSubmit = async event => {
        ...
        this.props.history.push({pathname: `/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/verification`, state: {email: this.state.email, userName:this.state.userName,phone_number:this.state.phone_number}})
    }
    handleChange = event => {
        this.setState({
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className={'action-row'}>
                                ...
                                <div>
                                    ...
                                    <Link exact to={`/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/signin`} style={{textDecoration: 'none'}}>
