...
import {getAllCategories} from "../../../actions/readitActions/categoryActions";
import {getCategoryPosts} from "../../../actions/readitActions/postActions";
...
class Category extends Component {
    ...
    handleLogout = async event => {
        ...
        this.props.history.push({pathname: `/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/signin`})
                            ...
                            _.map(cat, c => {
                                return (
                                    <div className={'category'} key={c.title}>
                                        <Link className={'category ripple'} to={`/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/${c.title}`}>
                                            {c.title}
                                        </Link>
                                    </div>
                                )
