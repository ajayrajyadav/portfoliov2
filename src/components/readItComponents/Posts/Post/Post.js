...
import {
    createPost, deletePost, editPost, getAllPosts, getCategoryPosts,
    votePost
} from "../../../../actions/readitActions/postActions";
...
class Post extends Component {
    ...
    onSubmitNewPost = (values) => {
        ...
        this.props.createPost(values).then(() => this.props.history.push({pathname: `/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/${values.category}`}))
        this.closeEditPostModal()
    }
    onToPostSummary = () => {
                                ...
                                (
                                    <div className={"hh"} key={p.postId}>
                                        <div className={'post-list'}>
                                            ...
                                            <Link className={'no-u'}
                                                  to={`/portfolio/${slug('Web Apps')}/${slug('ReadIt! (AWS Serverless, React, Redux)')}/${p.category}/${p.postId}`}>
